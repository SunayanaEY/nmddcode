...
export class VerifyTrainingsComponent {
  ...
  breadcrumbItems: BreadcrumbItem[] = [
    ...
    tableColumns: TableColumn[] = [
      ...
      tableActions: TableAction[] = [
        { name: 'view', icon: 'bi bi-shield-fill-check', class: 'btn-info', title: 'View' },
  ...
  certificateModal!: ElementRef;
    ...
    const sessionData = sessionStorage.getItem('user');
      ...
      filters = { trainingTitle:null,scheme: null, trainingInstituteName: null, trainerName: null ,location:null,district:null,
